...
impl Tableable<UnpackFullRecord> for UnpackFullReport {
    fn get_header(&self) -> Vec<ColumnFormat> {
        vec![
            ...
            ColumnFormat::new("Exists".to_string(), false, Some((20, 20, 20)), None),
            ColumnFormat::new("Artifacts".to_string(), true, Some((20, 20, 20)), None),
        ]
    }
...
impl Tableable<UnpackCountRecord> for UnpackCountReport {
    fn get_header(&self) -> Vec<ColumnFormat> {
        vec![
            ColumnFormat::new("Package".to_string(), false, Some((20, 20, 20)), None),
            ColumnFormat::new("Site".to_string(), true, Some((20, 20, 20)), None),
            ColumnFormat::new("Files".to_string(), false, Some((20, 20, 20)), None),
            ColumnFormat::new("Dirs".to_string(), false, Some((20, 20, 20)), None),
        ]
    }
